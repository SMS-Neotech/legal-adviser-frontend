      ...
      <div className="flex justify-end w-full">
        <div className="flex flex-col items-end">
            ...
            <div className="flex items-start gap-4">
                <div className="group max-w-prose rounded-lg rounded-tr-none border bg-card text-card-foreground shadow-sm">
  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        ...
        <div className="rounded-lg rounded-tl-none border bg-card text-card-foreground shadow-sm">
            <div className="p-4 space-y-4 break-words text-xs">
              <ReactMarkdown
                remarkPlugins={[remarkGfm]}
                components={{
